...
app.config["MAX_CONTENT_LENGTH"] = 16 * 1024 * 1024  # Permission for 16MB only max, remember

DB_CONFIG = {
    "host": os.environ.get("DB_HOST", "localhost"),
    "user": os.environ.get("DB_USER", "root"),
    "password": os.environ.get("DB_PASSWORD", "@RaviraajJain5"), #Must
...
def load_model_background():
    ...
    try:
        ...
        if MODEL_PATH.exists():
            ...
            logger.warning("model.h5 not found – using simulation mode")
    ...
    try:
        ...
        try:
            if model is not None:
                ...
                logger.info("Model not ready → using simulation")
